...
def run_training(args):
  ...
  def progress(num_steps, metrics):
    ...
    _average_steps=metrics["eval/avg_episode_length"]
    # print("terminations")
    # print(metrics["eval/final_reward/termination"])
    # print(metrics["eval/final_reward/termination_std"])
    # print("Old")
    term_vals=metrics["eval/final_reward/termination"]
    count = int(jnp.sum(jnp.abs(term_vals) < 0.5))
    average_steps.append(count)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_evals', type=int, default=2, help='Number of evaluations')
