...
#ifndef MEDIAN_FILL_FILTER_HPP_
#define MEDIAN_FILL_FILTER_HPP_
...
class MedianFillFilter : public filters::FilterBase<T> {
 ...
 protected:
   ...
   */
  static float getMedian(Eigen::Ref<const grid_map::Matrix> inputMap, const grid_map::Index& centerIndex, size_t radiusInPixels, Size bufferSize);
   ...
   */
  static void addCvMatAsLayer(T& gridmap, const cv::Mat& cvLayer, const std::string& layerName);
