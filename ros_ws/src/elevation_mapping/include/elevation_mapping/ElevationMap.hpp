...
class ElevationMap {
 public:
   ...
   * @return void 
   */
  void getHeightMap(const Eigen::Vector3d& position,double yaw);
  /*!
 ...
 private:
  ...
  bool applyInpaintingFilter(const grid_map::GridMap& input_map, grid_map::GridMap& output_map);
  /*!
  ...
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr heightMapFusedPublisher_;
  
  sensor_msgs::msg::PointCloud2  heightmap_msg;
